...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { bdates: @option.bdates, blocktime: @option.blocktime, date: @option.date, slots: @option.slots } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { bdates: @option.bdates, blocktime: @option.blocktime, date: @option.date, slots: @option.slots } }
